<?php
	...
	if(isset($_POST['name'])){
		...
		$data->insertReport($_POST['name'],$_POST['email'],$_POST['message']);
		$thongbao = "<p style='background: #3cc6c2; width: max-content; padding: 6px;'>Ý kiến gửi thành công</>";
	}
?>
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container-wrap">
			<div class="top-menu">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.php">Ngyen Hong Ha</a></div>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="form-group">
								<input style="color:black !important;background-color:#fff" name="name" type="text" class="form-control" placeholder="Name">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<input style="color:black  !important;background-color:#fff;" type="text" name="email" class="form-control" placeholder="Email">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<textarea style="color:black !important;background-color:#fff;" name="message" class="form-control" id="" cols="30" rows="7" placeholder="Message"></textarea>
							</div>
						</div>
						<div class="col-md-12">
							
								<input style="color:black " type="submit"  name="submit" value="Send Message" class="btn btn-primary btn-modify">
