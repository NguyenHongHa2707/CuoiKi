	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container-wrap">
			<div class="top-menu">
				<div class="row">
					<div class="col-xs-2">
						<div style="font-size:18px;"id="fh5co-logo"><a href="index.php">Nguyễn Hồng Hà</a></div>
					</div>
				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 slider-text">
				   				<div class="slider-text-inner">
				   					<h1> Not Every Project Needs To Be Perfect</h1>
										<h2>Design by NHH</a></h2>
										<p><a class="btn btn-primary btn-demo" style="color:black !important" href="#" ></i> View Demo</a> <a class="btn btn-primary btn-learn" style="color:black !important";>Learn More</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-push-3 slider-text">
				   				<div class="slider-text-inner">
				   					<h1>WordPress Theme For People Who Tell Stories</h1>
										<h2> Design by Nguyen Hong Ha</h2>
										<p><a class="btn btn-primary btn-demo" href="#" style="color:black !important"> </i> View Demo</a> <a class="btn btn-primary btn-learn" style="color:black !important">Learn More</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				   			...
				   			<div class="col-md-6 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>What Would You Like To Learn?</h1>
										<p style="color:black !important">  Learn More</p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-push-3 slider-text">
				   				<div class="slider-text-inner">
				   					<h1>I Love to Tell My Story</h1>
										...
										<p><a class="btn btn-primary btn-demo" href="#" style="color:black !important"></i> View Demo</a>
										 <a class="btn btn-primary btn-learn" style="color:black !important">Learn More</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
		...
		<div id="fh5co-services">
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<span class="icon">
							<i style="color:black !important"sclass="icon-diamond"></i>
						</span>
						<div class="desc">
			...
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<a href="work-single.php" class="work" style="background-image: url(images/portfolio-3.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span style="color:black">Illustration</span>
						</div>
					</a>
				</div>
			</div>
