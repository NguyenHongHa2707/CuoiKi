...
<html>
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container-wrap">
			<div class="top-menu">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo" style="font-size:18px";><a href="index.php">Nguyễn Hồng Hà</a></div>
					</div>
	...
	<div class="container-wrap">
		<div  style="overflow:scroll;" id="fh5co-about">
			<div class="row animate-box">
				<div style=" float:left;"class="col-md-12 heading-section">
					<h3 style="text-transform: uppercase;font-size:40px;"><?php echo $dataPost[0]['title'] ?></h3>
					<p><?php echo $dataPost[0]['description'] ?></p>
				</div>
			</div>
