	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container-wrap">
			<div class="top-menu">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.php">Nguyễn Hồng Hà</a></div>
					</div>
				...
				foreach ($data->selectPost() as $post) {
					...
					<div class="col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#" class="blog-bg" style="background-image: url('.$post['link_image'].');"></a>
							<div class="blog-text">
								<span class="posted_on">'.date("Y-m-d",$post['time_add']).'</span>
								<h3><a href="#">'.$post['title'].'</a></h3>
								<p>'.$post['description'].'</p>
								<ul class="stuff">
									<li><i class="icon-heart3"></i>249</li>
									<li><i class="icon-eye2"></i>1,308</li>
									<li><a href="blogDetail.php?id_post='.$post['id_post'].'">Read More<i class="icon-arrow-right22"></i></a></li>
								</ul>
							</div> 
						</div>
					</div>
