	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container-wrap">
			<div class="top-menu">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.php" style="font-size:18px;">Nguyễn Hồng Hà</a></div>
					</div>
	...
	<div class="container-wrap">
		   			...
		   			<div class="row">
			   			<div class="col-md-6 col-md-offset-3 slider-text slider-text-bg">
			   				<div class="slider-text-inner text-center">
			   					<h1>Work</h1>
									<h2>Free html5 templates Available at NHH</h2>
			   				</div>
			   			</div>
			   		</div>
			   	</li>		   	
		...
		<div id="fh5co-work">
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<a href="work-single.php" class="work" style="background-image: url(images/portfolio-4.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Illustration</span>
						</div>
				...
				<div class="col-md-4 text-center animate-box">
					<a href="work-single.php" class="work" style="background-image: url(images/portfolio-5.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Brading</span>
						</div>
				...
				<div class="col-md-4 text-center animate-box">
					<a href="work-single.php" class="work" style="background-image: url(images/portfolio-6.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Illustration</span>
						</div>
